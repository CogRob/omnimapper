...
SRC_FILES=( \
  ar_marker_plugin.cpp \
  benchmark_icp_lc.cpp \
  benchmark_icp_seq.cpp \
  canonical_scan.cpp \
  canonical_scan_matcher_plugin.cpp \
  csm_math_functions.cpp \
  csm_visualizer.cpp \
  error_evaluation_plugin.cpp \
  get_transform_functor_tf.cpp \
  omnimapper_ros.cpp \
  omnimapper_ros_handheld.cpp \
  omnimapper_ros_node.cpp \
  omnimapper_ros_nodelet.cpp \
  omnimapper_ros_openni.cpp \
  omnimapper_ros_pcd.cpp \
  omnimapper_visualizer_rviz.cpp \
  ros_tf_utils.cpp \
  ros_time_utils.cpp \
  tf_pose_plugin.cpp \
  time_test.cpp \
  tum_data_error_plugin.cpp \
)

N=$(nproc)
INPUT_FILE=/home/shengye/CogRob/omnimapper/shengye_tools/omnimapper_clang_rename.yaml
SRC_PATH=/home/shengye/CogRob/omnimapper/ros/omnimapper_ros/src
OUTPUT_PATH=/home/shengye/CogRob/omnimapper/ros/omnimapper_ros/src_new
