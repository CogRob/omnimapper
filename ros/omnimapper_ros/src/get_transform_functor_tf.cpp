...
omnimapper::GetTransformFunctorTF::GetTransformFunctorTF (std::string sensor_frame_name, std::string base_frame_name) 
...
Eigen::Affine3d
omnimapper::GetTransformFunctorTF::operator()(omnimapper::Time t)
{
  ros::Time ros_time = ptime2rostime (t);
  tf::StampedTransform tf_transform;
  try
  {
    tf_listener_.waitForTransform (base_frame_name_, sensor_frame_name_, ros_time, ros::Duration (0.2));
    tf_listener_.lookupTransform (base_frame_name_, sensor_frame_name_, ros_time, tf_transform);
  } 
