...
class OmniMapperROSOpenNI
{
  public:
        ...
        publish_cloud_ (true)
    {
      ...
      boost::function<void (const CloudConstPtr&)> f = boost::bind (&OmniMapperROSOpenNI<PointT>::cloudCallback, this, _1);
...
int main (int argc, char** argv)
{
  ...
  //boost::function<void (const CloudConstPtr&)> f = boost::bind (&OmniMapperROS<pcl::PointXYZRGBA>::cloudCallback, &omnimapper, _1);
