 ...
 */
class OrientedPlane3Factor: public gtsam::NoiseModelFactor2<gtsam::Pose3, OrientedPlane3> {
...
public:
  ...
  OrientedPlane3Factor(const gtsam::Vector&z, const gtsam::SharedGaussian& noiseModel,
  ...
  /// evaluateError
  virtual gtsam::Vector evaluateError(const gtsam::Pose3& pose, const OrientedPlane3& plane,
      boost::optional<gtsam::Matrix&> H1 = boost::none, boost::optional<gtsam::Matrix&> H2 =
          boost::none) const {
...
class OrientedPlane3DirectionPrior: public gtsam::NoiseModelFactor1<OrientedPlane3> {
protected:
...
public:
  ...
  virtual gtsam::Vector evaluateError(const OrientedPlane3& plane,
